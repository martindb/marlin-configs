...
//#define LIN_ADVANCE // MDB
  ...
  #else
    //#define ADVANCE_K 0.22        // (mm) Compression length applying to all extruders // MDB
    #define ADVANCE_K 0.48        // Unit: mm compression per 1mm/s extruder speed // MDB use metodo de la pagina de Marlin
#endif
